...
Note for eastern ontario and Golden horseshoe, there is an error because these pages had no table of contents. Uncommenting will assign the correct table of contents name
```{r}
...
######select only columns of interest from all dataframes. These are: Name, Established, and Coordinates
#using lapply
```{r}
...
Now that we have the lat/long and dates we will plot them on a geojon shape file for ontario
```{r}
# Add the map -------------------------------------------------------------
